...
#ifndef ISOTROPIC
double SquareWellium::computePairEnergy(const unsigned int particle1, const double* position1, const unsigned int type1,
...
#else
double SquareWellium::computePairEnergy(const unsigned int particle1,
