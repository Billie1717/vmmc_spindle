...
#ifndef ISOTROPIC
double SquareWelliumWall::computePairEnergy(const unsigned int particle1, const double* position1, const unsigned int type1,
...
#else
double SquareWelliumWall::computePairEnergy(const unsigned int particle1,
